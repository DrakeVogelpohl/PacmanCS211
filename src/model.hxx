...
static ge211::Posn<int> const Red_start = {1*grid_size, 1*grid_size};
// Starting position for the blue ghost
static ge211::Posn<int> const Blue_start = {17*grid_size, 1*grid_size};
// Starting position for the pink ghost
static ge211::Posn<int> const Pink_start = {1*grid_size, 19*grid_size};
// Starting position for the orange ghost
static ge211::Posn<int> const Orange_start = {17*grid_size, 19*grid_size};
...
public:
    ...
    //set all ghosts positions
    void set_ghosts(Position pos);

    // set all ghosts to top left and orange to the pos
    void set_orange_ghost(Position pos);

    //set all player position and velocity
    void set_player_pos(Position pos);
    void set_player_vel(ge211::Dims<int> vel);
