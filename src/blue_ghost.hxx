...
//#ifndef PAC_MAN_BLUE_GHOST_HXX
//#define PAC_MAN_BLUE_GHOST_HXX
#pragma once
#include "player.hxx"
#include "dots.hxx"
#include "walls.hxx"
...
public:
    ...
    // The blue ghost will prioritize moving towards the left, then down,
    // then up, then right
    BlueGhost velocity_next(Walls w);
